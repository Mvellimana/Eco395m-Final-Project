#we combine all the grouped files as a result of the 4-part code
...
#generate a csv that provides top 5 best mexican restaurants for every food category
...
#generate a csv that provides top 5 worst mexican restaurants for every food category
